...
<html>
    ...
    <div class="container">
        ...
        if (is_array($post)):
            ...
            $where .= " and a.MECDATALOTE <=  '2050-12-31'";
            ...
            AND e.NOME_APELIDO LIKE :buscar
            AND NOT b.NCMID = '56' 
            AND NOT b.NCMID = '65'
            AND NOT b.NCMID = '66'
            AND NOT b.NCMID = '68'
        ...
        if (is_array($post)):
            ...
            @$where1 .= "AND h.NOME_APELIDO LIKE :buscar ";            
                 ...
                 if(!empty($post['receituario'])):
            @$where1 .= "AND d.MATDESCRICAO = '" . $post['receituario'] . "' ";            
            endif;
          
            if(!empty($post['oculosDeSol'])):
            @$where1 .= "AND d.MATDESCRICAO = '" . $post['oculosDeSol'] . "' ";            
            endif;
            

            $read = $conn->prepare("SELECT  h.NOME_APELIDO AS CODNOME, h.COR AS COR, sum(l.PICQTDE) AS TOTAL 
                            FROM TB_VEN_VENDA a
