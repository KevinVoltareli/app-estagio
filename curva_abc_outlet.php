...
<html>
    ...
    <div class="container">
        ...
        if (is_array($post)):
            ...
            $read = $conn->prepare("SELECT e.NOME_APELIDO as APELIDO, e.ARMDESCRICAO, sum(a.MECQUANTIDADE1) AS QTD, e.COR AS COR
            ...
            AND NOT b.NCMID = '71'
            AND NOT b.NCMID = '75'
            GROUP BY e.NOME_APELIDO, e.ARMDESCRICAO, e.COR 
            ORDER BY QTD DESC");
        ...
        if (is_array($post)):
            ...
            @$where1 .= "AND h.NOME_APELIDO LIKE :buscar ";            
            endif;
            
            $read = $conn->prepare("SELECT h.NOME_APELIDO AS NOME, h.COR, sum(l.PICQTDE) AS TOTAL 
            FROM TB_VEN_VENDA a
            ...
            INNER JOIN TB_DRIP_APELIDO_OUTLET h ON h.MATFANTASIA  = d.MATFANTASIA
            ...
            AND NOT e.NCMID = '73'  
            AND NOT e.NCMID = '75'
            GROUP BY  h.NOME_APELIDO, l.PICQTDE, h.COR 
            ORDER BY TOTAL desc");
