...
<html>
    ...
    <body>
        ...
        if (is_array($post)):
            ...
            $read = $conn->prepare("SELECT MVMDATAMOV, a.MATID AS codigo,b.MATFANTASIA, sum(a.MVMQUANTIDADE) AS total "
                    . "FROM TB_MVM_MOVMATITEM a "
                    . "INNER JOIN TB_MAT_MATERIAL b ON a.MATID = b.MATID "
                    . "{$where} GROUP BY a.MATID , MVMDATAMOV, b.MATFANTASIA ORDER BY a.MATID, MVMDATAMOV");
            ...
            <table width="500px" border="1">
                ...
                foreach ($array as $dados): 
                    ...
                    ?>
                    <tr>
                        <td><?php echo $dados["MVMDATAMOV"]; ?></td>
