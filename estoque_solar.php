...
<html>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="form-group">  
                                            <label>Selecione o gênero</label><br>
                                                <select class="col-md-12" id="genero" name="genero">
                                                    <option value="">
                                                        <?php 
    ...
    <div class="col-md-4 pb-0">
        ...
        if (is_array($post)):
            ...
            if($post['genero'] == 'FEMININO' || $post['genero'] == 'MASCULINO'):
            @$where .= " AND e.SUB_LINHA2 =  '" . $post['genero'] . "'";
            endif;
       ...
       @$buscar = strtoupper("%".($_POST['buscar'])."%");
        ...
        if (is_array($post)):
            ...
            if($post['filial'] == '1' || $post['filial'] == '2' || $post['filial'] == '4' || $post['filial'] == '5'):
            @$where1 .= " AND i.FILID_FILIAL = '" . $post['filial'] . "'";   
            endif;

            if($post['genero'] == 'FEMININO' || $post['genero'] == 'MASCULINO'):
                @$where1 .= " AND h.SUB_LINHA2 =  '" . $post['genero'] . "'";
                endif;
            ...
            h.NOME_APELIDO AS NOME,
            SUM(l.PICQTDE) AS TOTAL
        FROM
            TB_VEN_VENDA a
        ...
        {$where1}
            ...
            AND NOT e.NCMID IN ('56', '65', '66', '68', '71', '73', '75')
            AND h.GRIFE ='SUNGLASS'
        GROUP BY
            h.NOME_APELIDO,
            l.PICQTDE
        ORDER BY
