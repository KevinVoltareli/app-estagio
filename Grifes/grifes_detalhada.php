    ...
    <div class="container_toggle">
        ...
        <div class="head">Menu</div>
            <ol>
                ...
                <li><a href="grifes.php"><i class="fa fa-bookmark" aria-hidden="true"></i>Grifes</a></li>
  ...
  <!--FIM TOGGLE MENU  -->
    ...
    <div class="container">
        ...
        if (is_array($post)):
            ...
            $read = $conn->prepare("SELECT e.GRIFE AS GRIFE, e.LINHA AS COR,  sum(a.MECQUANTIDADE1) AS QTD
                            ...
                            INNER JOIN TB_PROD_LOJA e ON e.MATFANTASIA = b.MATFANTASIA 
                            {$where}                            
                            AND NOT c.FILID = '1'
                            AND NOT c.FILID = '5'                            
                            AND NOT c.FILID = '7'
       ...
       @$buscar = strtoupper("%".($_POST['buscar'])."%");
        ...
        if (is_array($post)):
            ...
            $read = $conn->prepare("SELECT h.GRIFE AS GRIFE, h.LINHA as COR, sum(l.PICQTDE) AS TOTAL
                                    FROM TB_VEN_VENDA a
                                    ...
                                    INNER JOIN TB_PROD_LOJA h ON h.MATFANTASIA  = d.MATFANTASIA
                                    ...
                                    AND NOT e.NCMID = '73'  
                                    AND NOT e.NCMID = '75'
                                    GROUP BY  h.GRIFE, l.PICQTDE,h.LINHA
                                    ORDER BY TOTAL DESC ");
